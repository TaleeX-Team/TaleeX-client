    ...
    return (
        <div className="hidden lg:flex flex-col items-center space-y-6 w-1/2 pr-12 mb-8 lg:mb-0 animate-fade-in">
            ...
            <div className="text-center space-y-4 max-w-md">
                <h1 ref={headingRef} className="text-4xl font-bold text-gradient bg-clip-text text-primary bg-gradient-to-r from-purple-500 via-purple-600 to-purple-400">
                    TalentSync
                </h1>
                <p className="text-xl text-primary dark:text-primaryleading-relaxed transition-colors duration-300">
                    Smarter hiring starts here.
                </p>
                <div className="py-6">
                    <blockquote className="border-l-4 border-primary pl-4 italic text-primary dark:text-primary transition-colors duration-300">
                        ...
                        <div className="flex justify-center space-x-6">
                            <div
                                className={`w-8 h-8 rounded-full ${
                                    isDark ? 'bg-primary/30' : 'bg-primary/70'
