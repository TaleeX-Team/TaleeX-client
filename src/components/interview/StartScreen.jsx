...
import {
  useInterviewData,
  useStartInterview,
} from "@/hooks/useInterviewData.js";
    ...
    <div className="min-h-screen flex flex-col">
        ...
        {interviewHeaderData && (
          <div className="flex items-center space-x-3">
            ...
            <div className="font-medium text-gray-900 dark:text-gray-100">
              {interviewHeaderData.companyName}
            </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row p-4 md:p-8 gap-6">
        ...
        <div className="w-full md:w-2/3">
          <Card
            className="h-full flex flex-col p-8 shadow-xl rounded-xl bg-gradient-to-br from-white to-blue-50 border border-input"
            style={{
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-200 max-w-lg">
                  You'll be interviewed by TaleeX AI Assistant on behalf of{" "}
                  {interviewHeaderData?.companyName}
                  {/* {interviewHeaderData && (
              ...
              <div className="w-full max-w-md">
                ...
                {!isExpired && !questionsError && (
                  <p className="text-sm text-gray-500 dark:text-gray-300 mt-2">
                    By proceeding, you agree to be recorded (video and audio)
                    for evaluation and identity verification purposes.{" "}
                  </p>
                )}
              </div>
            </div>
