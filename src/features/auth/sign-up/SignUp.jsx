    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-slate-50 p-4">
            <Card className="w-full max-w-4xl bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="flex flex-col md:flex-row h-[680px]"> {/* Increased height */}
                    ...
                    <div className="hidden md:block w-2/5 bg-purple-50 relative">
                        ...
                        <div className="absolute bottom-6 right-6 w-24 h-24 bg-purple-300 rounded-full opacity-20"></div>
                    </div>

                    {/* Right Side - Form */}
                    <div className="w-full md:w-3/5 p-6 md:p-8"> {/* Increased padding */}
                        ...
                        <div className="max-w-md mx-auto space-y-4"> {/* Increased vertical spacing */}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="john.doe@gmail.com" className="h-10" {...field} />
                                                    </FormControl>
                                                    <FormMessage className="text-xs" />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="+1 (555) 000-0000" className="h-10" {...field} />
                                                    </FormControl>
                                                    <FormMessage className="text-xs" />
                                                </FormItem>
                                            )}
                                            ...
                                            <FormItem className="flex flex-row items-start space-x-2 space-y-0">
                                                ...
                                                <div className="leading-none">
                                                    <FormLabel className="text-xs font-normal">
                                                        I agree to all the <span className="text-blue-500 font-medium">Terms</span> and <span className="text-pink-500 font-medium">Privacy Policies</span>
                                                    </FormLabel>
                                                    <FormMessage className="text-xs" />
                                                </div>
                                            </FormItem>
                            ...
                            <div className="text-center">
                                <p className="text-xs text-gray-600">
                                    Already have an account? <span className="text-blue-600 font-medium">Login</span>
                                </p>
                            </div>
