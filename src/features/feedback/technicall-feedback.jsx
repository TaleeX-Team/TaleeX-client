        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="results" className="space-y-6">
              ...
              <CardContent className="space-y-8">
                ...
                {feedback.redflag && (
                  <Section
                    title="Concerns"
                    icon={
                      <MessageSquare className="h-5 w-5 text-red-700 dark:text-destructive/80" />
                    }
                  >
                    <p className="text-red-700 dark:text-destructive/80">
                      {feedback.redflag}
                    </p>
                  </Section>
                )}
            ...
            <div className="text-xs text-muted-foreground text-center mt-6">
              Generated by TaleeX AI. While we strive for accuracy, we recommend
              reviewing the interview overview for clarity and context.
            </div>
          </TabsContent>
