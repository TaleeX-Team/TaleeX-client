...
export default function JobApplicationPage() {
    ...
    const getVerificationBadge = () => {
        ...
        if (status === "verified") {
            return (
                <Badge variant="outline" className="bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800 flex items-center gap-1">
            ...
            return (
                <Badge variant="outline" className="bg-amber-50 dark:bg-amber-950 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800 flex items-center gap-1">
        ...
        <div className="container max-w-4xl mx-auto py-8 px-4">
            {isSubmitSuccess && (
                <Alert className="mb-6 bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-800">
                    ...
                    <AlertTitle className="text-green-800 dark:text-green-400">Application Submitted</AlertTitle>
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <Badge variant={jobData.status === "open" ? "success" : "secondary"}>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-md border border-blue-200 dark:border-blue-800 mt-4">
                        ...
                        <div>
                            <p className="text-sm text-blue-700 dark:text-blue-300">
                                <span className="font-medium">Safety Notice:</span> If this job appears suspicious,
                                please use the <Flag className="h-3 w-3 inline mx-1" /> Report button. Never send money or share financial details.
                            </p>
                        </div>
                        <Button
                            variant="outline"
            ...
            {jobData.company.verification.status === "pending" && (
                <Alert className="my-6 bg-amber-50 dark:bg-amber-900/30 border-amber-200 dark:border-amber-800">
                    ...
                    <AlertTitle className="text-amber-800 dark:text-amber-400">Company Pending Review</AlertTitle>
                    <AlertDescription className="text-amber-700 dark:text-amber-300">
                        This company's profile is currently pending verification. Please exercise caution and research
                        the company before applying. If anything seems suspicious, please use the report feature above.
                    </AlertDescription>
                </Alert>
            )}
