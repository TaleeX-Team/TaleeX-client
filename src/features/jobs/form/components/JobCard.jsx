...
import { Briefcase, Building2, Clock, DollarSign, MapPin, User, ExternalLink } from "lucide-react"
import { Link } from "react-router-dom"
import { Button } from "@/components/ui/button"
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar"

export default function JobCard({ job }) {
    const { _id, title, company, workPlaceType, jobType, experienceLevel,applicationLink, status, salary, openTime } = job
                                    ...
                                    <TooltipProvider>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Badge variant="outline" className="ml-1.5 bg-blue-50 text-blue-700 border-blue-200 text-xs py-0 dark:bg-blue-950/50 dark:text-blue-300 dark:border-blue-900">
                                                    ✓
                                                </Badge>
                                            </TooltipTrigger>
                                            <TooltipContent>
