...
export default function JobCard({ job }) {
  const { _id, title, company, jobType, experienceLevel, status, openTime, tags, description } =
    job
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <div className="flex items-center flex-wrap gap-2">
              ...
              {experienceLevel && (
                <Badge className={`px-2 py-0.5 text-xs bg-muted text-muted-foreground capitalize`}>{experienceLevel}</Badge>
              )}
