                      ...
                      {applicant?.feedback?.cv && (
                        <Dialog>
                          <DialogTrigger asChild>
                            ...
                            >
                              {t("reject.rejectedApplicantss.table.feedbacks.cv")}
                            </Button>
                          </DialogTrigger>
                        ...
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button
                              ...
                              className="h-8 px-3"
                            >
                              {t("reject.rejectedApplicantss.table.feedbacks.feedback")}
                            </Button>
                          </DialogTrigger>
                          <DialogContent className="!w-full !max-w-5xl max-h-[90vh] overflow-y-auto">
                        ...
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button
                              ...
                              className="h-8 px-3"
                            >
                              {t("reject.rejectedApplicantss.table.feedbacks.finalFeedback")}
                            </Button>
                          </DialogTrigger>
                          <DialogContent className="!w-full !max-w-5xl max-h-[90vh] overflow-y-auto">
                            <FinalFeedbackPage
                          ...
                          <TooltipTrigger asChild>
                            ...
                            >
                              ...
                              >
                                ...
                                <span className="sr-only">{t("reject.rejectedApplicantss.table.cv.open")}</span>
                              </a>
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent>
                            <p>{t("reject.rejectedApplicantss.table.cv.open")}</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    ) : (
