  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        {(activePhase === t("cuurentPhase.phases.cvReview") ||
          activePhase === t("cuurentPhase.phases.applications")) && (
          <Dialog
            open={openInterview}
          ...
          >
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>
                  {t("dialogs.sendVideoInterview.title")}
                </DialogTitle>
                <DialogDescription>
              ...
              <div className="grid gap-4 py-4">
                <div className="space-y-2">
                  <Label>
                    {t(
                      "cuurentPhase.dialogs.sendVideoInterview.interviewType.label"
                    )}
                  </Label>
                  <p className="text-sm text-muted-foreground">
                    {t(
                      "cuurentPhase.dialogs.sendVideoInterview.interviewType.description"
                    )}
                  </p>
                  <div className="flex gap-4">
                    ...
                    >
                      <Label htmlFor="technical" className="cursor-pointer">
                        {t(
                          "cuurentPhase.dialogs.sendVideoInterview.interviewType.technical"
                        )}
                      </Label>
                    </div>
                    <div
                    ...
                    >
                      <Label htmlFor="behavioral" className="cursor-pointer">
                        {t(
                          "cuurentPhase.dialogs.sendVideoInterview.interviewType.behavioral"
                        )}
                      </Label>
                    </div>
                  </div>
                  {showInterviewError && (
                    <Alert variant="destructive">
                      <AlertDescription>
                        {t(
                          "cuurentPhase.dialogs.sendVideoInterview.interviewType.error"
                        )}
                      </AlertDescription>
                    </Alert>
                  )}
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label>
                      {t(
                        "cuurentPhase.dialogs.sendVideoInterview.questionCount.label"
                      )}
                    </Label>
                ...
                <div className="space-y-2">
                  <Label>
                    {t(
                      "cuurentPhase.dialogs.sendVideoInterview.expiryDate.label"
                    )}
                  </Label>
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {expiryDate ? (
                          ...
                          <span>
                            {t(
                              "cuurentPhase.dialogs.sendVideoInterview.expiryDate.placeholder"
                            )}
                          </span>
                        )}
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t(
                      "cuurentPhase.dialogs.sendVideoInterview.expiryDate.description"
                    )}
                  </p>
                </div>
                ...
                {selectedApplicants.length > 0 && (
                  <div className="p-3 rounded-md border bg-muted">
                    <p className="text-sm font-medium">
                      {t("cuurentPhase.dialogs.selectedApplicants.title")}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      {t(
                        "cuurentPhase.dialogs.selectedApplicants.description",
                        {
              ...
              <DialogFooter>
                ...
                <Button onClick={handleSubmitInterview}>
                  {t("cuurentPhase.dialogs.sendInterview")}
                </Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
...
-300 dark:border-gray-700 dark:hover:bg-gray-800 disabled:opacity-50 dark:disabled:hover:bg-transparent"
        ...
        <Dialog open={openOffer} onOpenChange={handleOfferDialogChange}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>
                {t("cuurentPhase.dialogs.sendOfferEmail.title")}
              </DialogTitle>
              <DialogDescription>
            ...
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="emailSubject">
                  {t("cuurentPhase.dialogs.sendOfferEmail.emailSubject.label")}
                </Label>
                <Input
                  id="emailSubject"
                  value={emailSubject}
                  ...
                  placeholder={t(
                    "cuurentPhase.dialogs.sendOfferEmail.emailSubject.placeholder"
                  )}
                  required
                  minLength={10}
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="emailBody">
                  {t("cuurentPhase.dialogs.sendOfferEmail.emailBody.label")}
                </Label>
                <textarea
                  id="emailBody"
                  value={emailBody}
                  ...
                  placeholder={t(
                    "cuurentPhase.dialogs.sendOfferEmail.emailBody.placeholder"
                  )}
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSubmitOffer}>
                {t("cuurentPhase.dialogs.sendOffer")}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
                    ...
                    {applicant.cvScore !== undefined ? (
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            {t("cuurentPhase.table.scoreTooltip", {
