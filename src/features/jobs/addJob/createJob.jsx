...
export default function AddJob() {
    ...
    const { data: companies = [], isLoading: isCompaniesLoading, isError: isCompaniesError } = useNonRejectedCompanies();
            ...
            ...(values.salary?.min || values.salary?.max || values.salary?.currency
                ? {
                    salary: {
                        ...
                        ...(values.salary.currency && { currency: values.salary.currency }),
                    },
                }
                : {}),
            ...(values.hiringTarget && { hiringTarget: parseInt(values.hiringTarget, 10) }),
        };

        createJobMutation.mutate(transformedValues, {
            onSuccess: () => {
            ...
            <DialogContent className="sm:max-w-[800px] md:max-w-[900px] p-0 bg-background">
                <div ref={formContainerRef}>
                    <DialogHeader className="px-6 pt-6 pb-2">
                        <DialogTitle className="text-2xl font-semibold">Create New Job Posting</DialogTitle>
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <DialogFooter className="px-6 py-4 flex justify-between sm:justify-end gap-2 border-t">
                                        ...
                                        <Button
                                            ...
                                            disabled={createJobMutation.isPending || isCompaniesLoading || isCompaniesError || companies.length === 0}
                                        >
