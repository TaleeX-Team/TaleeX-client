...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Set a small delay before updating state to avoid flickering
  ...
  return (
      <div className="sticky top-4 z-40 flex justify-center w-full px-4">
        <header
            className={`flex items-center justify-between backdrop-blur supports-[backdrop-filter]:bg-background/90 transition-all duration-500 ${
                scrolled
