...
export default function Header() {
  ...
  return (
    <div className="sticky top-4 z-40 flex justify-center w-full px-4 transition-all duration-300">
      <header
        className={`flex items-center justify-between transition-all duration-300 backdrop-blur supports-[backdrop-filter]:bg-background/90 ${scrolled
          ? "h-14 max-w-4xl w-full px-6 py-2 bg-background/95 border border-slate-200 dark:border-slate-800 rounded-full shadow-md"
          : "h-16 w-full bg-background border-b"
          }`}
      >
