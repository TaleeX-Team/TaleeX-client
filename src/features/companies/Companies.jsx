  ...
  return (
      <div className="bg-background p-4 md:p-8 min-h-screen">
        <div className="mx-auto max-w-7xl">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="outline" size="icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4">
                  <path d="M3.5 8.5L7.5 12.5L11.5 8.5M3.5 2.5L7.5 6.5L11.5 2.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </Button>
            </div>
          </div>
          ...
          {isError && (
              <div className="text-center py-16 px-4 bg-destructive/5 rounded-lg border border-destructive/20">
                ...
                <p className="text-muted-foreground mb-4">There was an error fetching your company data. Please try again.</p>
          ...
          {!isLoading && !isError && (
              <>
                {companies?.companies?.length > 0 ? (
                    ...
                    <div
                        ref={emptyStateRef}
                        className="flex flex-col items-center justify-center py-16 px-4 text-center bg-card rounded-xl border border-dashed border-muted-foreground/20"
                    >
