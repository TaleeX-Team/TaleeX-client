    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h3 className="font-semibold text-lg">{name || "Unnamed Company"}</h3>
                                {isFavorite && (
                ...
                <CardContent ref={contentRef} className="pb-2 flex-1">
                    <div className="space-y-2 text-sm">
                        <p className="text-muted-foreground line-clamp-3">{description || "No description available"}</p>
                        {address && (
                ...
                <CardFooter className="flex justify-between pt-4 border-t bg-muted/20 mt-auto">
            ...
            <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Delete {name || "this company"}?</AlertDialogTitle>
                        <AlertDialogDescription>
