...
const AdminDashboard = () => {
  ...
  const isLoading =
    ...
    interviewsByStateLoading ||
    conversionFunnelLoading ||
    topAppliedJobsLoading;
  ...
  const totalApplications =
    applicationsByStageData?.reduce((sum, item) => sum + item.count, 0) || 0;
  const totalInterviews =
    interviewsByStateData?.reduce((sum, item) => sum + item.count, 0) || 0;
  ...
  const rejectedApplications =
    applicationsByStageData?.find(
      (item) => item.stage.toLowerCase() === "rejected"
    )?.count || 0;
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Overview of application statistics and recruitment metrics
            </p>
          </div>
                    ...
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          ...
                          >
                            {formatApplicationsByStageForChart().map(
                              (entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                          ...
                          <div key={index}>
                            ...
                            <div className="w-full bg-muted rounded-full h-2.5">
                              <div
                                ...
                                style={{
                                  width: `${
                                    (item.count / totalInterviews) * 100
                                  }%`,
                                }}
                              ></div>
                            </div>
