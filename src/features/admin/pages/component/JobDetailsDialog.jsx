            ...
            <DialogContent className="sm:max-w-3xl max-h-[96vh] p-0 overflow-hidden border-border shadow-lg">
                ...
                <DialogHeader className="p-6 pb-2 space-y-2 border-b border-border bg-gradient-to-r from-background to-muted/30">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge
                            variant="outline"
                            className={`${getStatusStyles(job.status)} capitalize border-none px-3 py-1`}
                        >
                            {job.status}
                        </Badge>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-6 p-6">
                    ...
                    <span className="text-lg font-semibold">
                      {job.company && job.company.name ? job.company.name.charAt(0) : "C"}
                        ...
                        <div>
                            <h3 className="text-lg font-medium mb-3 text-foreground">Requirements</h3>
                            <div className="bg-muted/30 rounded-lg p-4 border border-border">
                                <p className="text-sm text-muted-foreground whitespace-pre-line">
                    ...
                    <div className="col-span-1 space-y-4">
                        ...
                        <div className="bg-muted/30 rounded-lg p-4 border border-border space-y-4">
                            <h3 className="font-medium border-b border-border pb-2 text-foreground">Job Details</h3>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium capitalize">{job.jobType || "Not specified"}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium capitalize">{job.workPlaceType || "Not specified"}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium">
                                            {job.hiringTarget ? `${job.hiringCount || 0}/${job.hiringTarget} positions filled` : "Not specified"}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium">{formatOpenTime(job.openTime)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {job.createdBy && (
                            <div className="bg-muted/30 rounded-lg p-4 border border-border">
                                <h3 className="font-medium border-b border-border pb-2 mb-3 text-foreground">Posted By</h3>
                                <div className="flex items-center gap-3">
                                    <Avatar className="h-8 w-8 bg-primary/10 text-primary flex items-center justify-center">
                    <span className="text-sm font-semibold">
                      {job.createdBy.firstName ? job.createdBy.firstName.charAt(0) : "U"}
                    </span>
                                    </Avatar>
                                    <div>
                                        <p className="text-sm font-medium">
                        ...
                        {job.tags && job.tags.length > 0 && (
                            <div className="bg-muted/30 rounded-lg p-4 border border-border">
                                <h3 className="font-medium border-b border-border pb-2 mb-3 text-foreground">Tags</h3>
                ...
                <DialogFooter className="px-6 py-4 border-t border-border bg-muted/30 flex flex-row justify-between items-center">
                    {job.applicationLink && (
                        <div className="flex items-center text-xs text-muted-foreground">
                            ...
                            <span className="truncate max-w-[300px]">{job.applicationLink}</span>
                        </div>
                    )}
                    <div className="flex gap-3">
                        <DialogClose asChild>
                            <Button variant="outline" className="border-border hover:bg-accent transition-colors duration-200">
                                Close
                            </Button>
                        </DialogClose>
                        <Button
