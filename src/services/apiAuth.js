...
export const getApplicationsByStage = async (params) => {
    ...
    const url = `/statistics/applications-by-stage?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getDailyApplications = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/daily-applications?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getJobsByCompany = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/jobs-by-company?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getDailyRegistrations = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/daily-registrations?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getReportsByReason = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/reports-by-reason?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getInterviewsByState = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/interviews-by-state?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getAvgTimePerStage = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/avg-time-per-stage?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getConversionFunnel = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/conversion-funnel?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getTimeToOfferPerJob = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/time-to-offer-per-job?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
...
export const getTopAppliedJobs = async (params) => {
    ...
    // Construct URL with proper parameters
    const url = `/statistics/top-applied-jobs?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
